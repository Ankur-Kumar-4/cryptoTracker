...
function List({ coin }) {
  return (
    <tr className="flex md:w-auto w-[97vw] justify-between items-center mx-1 gap-[1.5rem] md:mx-[1.5rem] hover:bg-darkgrey py-3 md:px-6 px-4 rounded-xl cursor-pointer">
      ...
      <td className="text-left w-[9%] md:w-[18%] md:ms-[4rem] ms-5  items-center flex">
